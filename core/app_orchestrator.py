...
_LANG_NAMES = {
    ...
    "arabic": "ar", "urdu": "ur", "bengali": "bn", "punjabi": "pa",
    "gujarati": "gu", "tamil": "ta", "telugu": "te", "malayalam": "ml",
    "marathi": "mr", "japanese": "ja", "chinese": "zh", "korean": "ko",
    "turkish": "tr", "dutch": "nl", "polish": "pl", "vietnamese": "vi",
    "thai": "th", "indonesian": "id", "malay": "ms", "swedish": "sv",
...
class AppOrchestrator:
    def __init__(self, config_path: str = "config/settings.json"):
        ...
        # Guard: prevent beep firing twice
    ...
    def stop(self) -> bool:
        try:
            ...
            if self.hotkey_listener: self.hotkey_listener.stop_listening()
            self.is_running = False
    ...
    def update_config(self, key: str, value) -> bool:
        try:
            ...
            if key == "startup_on_boot":
                if value: startup_manager.enable_auto_startup()
                else:     startup_manager.disable_auto_startup()
