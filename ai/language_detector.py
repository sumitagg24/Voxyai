...
class LanguageDetector:
    ...
    def get_language_specific_prompt(self, language_code: str, base_prompt: str) -> str:
...
HINGLISH_WORDS = {
    ...
    "kya soch raha hai",
    "kya soch rahi hai",
    "kya kar raha hai tum",
    "kya kar raha hai aap",
    "kya kar rahi hai tum",
    ...
    "kya karunga main hu",
    "kya karungi main hu",
    "kya karunga main hun",
    "kya karungi main hun",
}
